...
exports.mergeStackableRewards = mergeStackableRewards;
exports.collectRewardMessages = collectRewardMessages;
function isItemReward(reward) {
    return reward.type === "item";
}
function mergeStackableRewards(rewards) {
...
function collectRewardMessages(rewards) {
