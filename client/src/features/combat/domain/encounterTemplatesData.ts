import type { EncounterKey, EncounterTemplate } from "./encounterTemplateTypes";

export const encounterTemplatesData: Record<EncounterKey, EncounterTemplate> = {
  "north-road-goblin": {
    key: "north-road-goblin",
    speciesId: "goblin",
    encounterType: "creature",
    lootTableKey: "goblin-common",
    enemyName: "Goblin",
