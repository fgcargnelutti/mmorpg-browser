...
export const characterClassesData = {
    "wasteland-warrior": {
        key: "wasteland-warrior",
        name: "Wasteland Warrior",
        title: "Frontline Survivor",
        description: "A hardened survivor built for endurance, direct confrontation, and harsh wasteland routines. Excels in physical resilience, heavy labor, and reliable interactions across hostile territories.",
        baseHp: 100,
        baseSp: 30,
    ...
    arcanist: {
        ...
        description: "A fragile but powerful wielder of forgotten forces who excels through spiritual power, relic attunement, and mastery of arcane growth.",
        baseHp: 60,
        baseSp: 100,
        baseStamina: BASE_CHARACTER_STAMINA,
        carryWeight: 70,
    ...
    thief: {
        ...
        description: "A fast and adaptable opportunist who thrives on stealth, mobility, and resourceful exploration, but often struggles with trust in social interactions.",
        baseHp: 80,
        baseSp: 60,
        baseStamina: BASE_CHARACTER_STAMINA,
        carryWeight: 80,
