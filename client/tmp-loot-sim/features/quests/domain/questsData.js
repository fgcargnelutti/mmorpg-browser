export const questsData = {
    "maria-goblin-hunt": {
        ...
        title: "Goblin Hunt",
        description: "Maria wants the goblin threat near the northern ruins reduced before it spills back toward the farms.",
        category: "activity",
        logSection: "hunt",
        state: "available",
        source: {
        ...
        objectives: [
            {
                ...
                description: "Travel to North Forest and defeat the goblin lurking in the Goblin Ruins.",
                progress: {
                    current: 0,
                    required: 1,
                },
    ...
    "jane-sewer-whispers": {
        ...
        description: "Jane warns that the sewer below Belegard hides movement and secrets worth uncovering.",
        category: "side",
        logSection: "lore",
        state: "available",
        source: {
    ...
    "library-fragments": {
        ...
        description: "Search the ruined library for surviving scraps of knowledge and whatever still lies buried below the rubble.",
        category: "activity",
        logSection: "lore",
        state: "available",
        source: {
