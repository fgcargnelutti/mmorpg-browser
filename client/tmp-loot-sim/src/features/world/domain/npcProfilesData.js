export const npcProfilesData = {
    ...
    maria: {
        ...
        narrativeHint: "Maria feels like the first step toward a deeper rural questline.",
        narrativeStatusText: "Maria seems open to trade, but not yet ready to share all her secrets.",
        buyPlaceholderMessage: "System: Maria's potion stock is still a placeholder.",
        sellPlaceholderMessage: "System: Maria examines your natural goods with professional interest.",
