export const hideoutStructuresData = {
    house: {
        key: "house",
        name: "Shelter",
        description: "The core shelter of the hideout. Expanding it opens room for the rest of the camp to matter.",
        maxLevel: 2,
        tiers: [
            {
                level: 1,
    ...
    bed: {
        key: "bed",
        name: "Bedroll",
        description: "A proper resting spot for recovery and future hideout-based healing bonuses.",
        maxLevel: 2,
        tiers: [
            {
                level: 1,
    ...
    worktable: {
        key: "worktable",
        name: "Worktable",
        description: "A rough station for planning, crafting, and future utility-focused upgrades.",
        maxLevel: 2,
        tiers: [
            {
                level: 1,
    ...
    forge: {
        key: "forge",
        name: "Camp Forge",
        description: "A crude forge for future repair, refinement, and equipment-focused systems.",
        maxLevel: 2,
        tiers: [
            {
                level: 1,
