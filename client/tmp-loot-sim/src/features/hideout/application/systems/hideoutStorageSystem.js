function removeSingleItem(inventory, itemKey) {
...
function addStorageItem(itemCounts, itemKey, amount = 1) {
    return {
        ...itemCounts,
        [itemKey]: (itemCounts[itemKey] ?? 0) + amount,
    };
}
function removeStorageItem(itemCounts, itemKey, amount = 1) {
...
export function depositInventoryItemToHideoutStorage(hideoutState, inventory, itemKey) {
...
export function withdrawHideoutStorageItemToInventory(hideoutState, inventory, itemKey) {
    if (itemKey === "gold") {
